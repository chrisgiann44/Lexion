...
class Mycorrections extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
        ...
        if (this.props.state.insertions == undefined) {
            ...
            return (
                <React.Fragment>
                    <h1>
                        {" "}
                        Corrections or additions made by you and their status{" "}
                    </h1>
                    <div className="ownverbs">
                        ...
                        {this.props.state.insertions &&
                            this.props.state.insertions.data
                                .filter(result => result.type == "edit")
                                .sort((a, b) => {
                                    return a.id - b.id;
                                })
                                .map(result => (
...
export default connect(mapStateToProps)(Mycorrections);
